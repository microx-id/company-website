...
<html>
<head>
<title>Collaboration Form | Micro X Indonesia </title>
...
<!-- Custom Theme files -->
<link href="../assets/css/collaborate-form.css" rel="stylesheet" type="text/css" media="all" />
<!-- //Custom Theme files -->
<!-- web font -->
...
<body>
	...
	<div class="main-w3layouts wrapper">
        <div class="text-center">
            <img src="../assets/img/logo-no-bg.png" width="20%"/>
        </div>
        <br>
		...
		<div class="colorlibcopy-agile">
			<p>© 2022 Micro X Indonesia. All rights reserved</p>
		</div>
		<!-- //copyright -->
