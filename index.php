...
<body>
  ...
  <section id="topbar" class="d-flex align-items-center">
    <div class="container d-flex justify-content-center justify-content-md-between">
      <div class="contact-info d-flex align-items-center">
        ...
        <i class="bi bi-phone-fill phone-icon"></i> +62 821-3700-4524
      </div>
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index.html"><img src="assets/img/logo-no-bg.png"/></a></h1>
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item active" style="background-image: url(assets/img/slide/slide-1.jpg)">
          <div class="carousel-container">
            <div class="container">
              <h2 class="animate__animated animate__fadeInDown">Make The World Better With Circular Economy And Renewable Energy.</h2>
              <!-- <p class="animate__animated animate__fadeInUp">Make The World Better With Circular Economy And Renewable Energy.</p> -->
        ...
        <div class="carousel-item" style="background-image: url(assets/img/slide/slide-2.jpg)">
          <div class="carousel-container">
            <div class="container">
              <h2 class="animate__animated animate__fadeInDown">Eco Friendly</h2>
              <p class="animate__animated animate__fadeInUp">Innovate to make alternative fuels based on new and renewable energy (biomass based).</p>
              <a href="#about" class="btn-get-started animate__animated animate__fadeInUp scrollto">Read More</a>
            </div>
          </div>
        </div>
        ...
        <div class="carousel-item" style="background-image: url(assets/img/slide/slide-3.jpg)">
          <div class="carousel-container">
            <div class="container">
              <h2 class="animate__animated animate__fadeInDown">Cheaper Price</h2>
              <p class="animate__animated animate__fadeInUp">Offering competitive prices but friendly in the pocket of the consumer while environmentally friendly and less emission products.</p>
              <a href="#about" class="btn-get-started animate__animated animate__fadeInUp scrollto">Read More</a>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box iconbox-teal ">
              ...
              <p>Cattle  feed  is quite  costly,  therefore  a system  can be made  where  there  is an exchange  between  organic fertilizer  and cow concentrate.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box iconbox-pink">
              ...
              <h4><a href="">Electricity</a></h4>
              <p>Through  development,  electricity  can also  be generated  from biogas  for operations  of Farm.</p>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 cta-btn-container text-center">
            ...
            <a class="cta-btn align-middle" href="https://wa.me/6282137004524?text=Halo%20Micro%20X%20Indonesia" target="_blank">Chat Our Whatsapp</a>
          </div>
        </div>
    ...
    <section id="gallery" class="portfolio">
      <div class="container">
        ...
        <div class="row portfolio-container">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-competition">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            <div class="portfolio-wrap">
              <img src="assets/img/portfolio/sangsang-univ.jpeg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>4th Place Winner in Start Idea Competition</h4>
                <p>Micro X placed fourth in Start Idea Competition held by KT&G and Sand Sang University.</p>
                <div class="portfolio-links">
                  <a href="assets/img/portfolio/sangsang-univ.jpeg" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Micro X placed fourth in Start Idea Competition held by KT&G and Sand Sang University. ."><i class="bx bx-plus"></i></a>
                </div>
              </div>
            </div>
          </div>
